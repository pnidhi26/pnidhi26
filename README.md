...
[![My Skills](https://skillicons.dev/icons?i=cpp,python,javascript,typescript,react,nodejs,mongodb,amazon_aws,git,github,html,css,tailwind,vscode,pr&perline=10)](https://skillicons.dev)
